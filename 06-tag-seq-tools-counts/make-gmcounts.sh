...
SCRIPT="/scratch/02703/samsad/Peer/RNAseq/testall/tag-seq-tools/bin/TagSeqTools"
PARAM="gm.param"
LOGS="logs/"
...
for fil in ${INDIR}*bam; do
    ...
    echo "$SCRIPT GMCounts -i $fil -g $GFF -o $OFIL -n $ONON --primary-alignment > $OLOG" >> $PARAM
done
